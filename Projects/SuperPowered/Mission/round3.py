...
gyro_straight_forward_print(0,16,normal_speed)
pid_turn(-46,1,40)
...
r_arm_motor.run_for_degrees(-360,slow_speed)

mm_motor = MotorPair("A","B")
gyro_straight_forward_print(-45,16,fast_speed)
...
#pid_turn(-135,1,40)
mm_motor = MotorPair("B","A")
gyro_straight_forward_print(-125,40,fast_speed+20)
gyro_straight_forward_print(-175,64,fast_speed+20)#
gyro_straight_forward_print(-90,86,fast_speed+20)