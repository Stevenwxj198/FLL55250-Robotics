...
gyro_straight_forward_print(9,80,fast_speed)#
#gyro_straight_forward_print(0,16,normal_speed)#towards target
gyro_straight_forward_print(0,12,fast_speed)
mm_motor.move(13,"cm",0,normal_speed)
mm_motor = MotorPair("B","A")
gyro_straight_forward_print(7,4,normal_speed)
gyro_straight_forward_print(7,107,fast_speed)