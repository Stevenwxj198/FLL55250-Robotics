...
#gyro_straight_forward_cs(0,80,normal_speed)
gyro_straight_forward_print(4,107,normal_speed)
i = 0
while i < 4:
    i = i + 1
    mm_motor = MotorPair("B","A")
    #gyro_straight_forward(0,80,normal_speed)
    gyro_straight_forward_print(-1,7,normal_speed)
    mm_motor = MotorPair("A","B")
    #gyro_straight_forward(0,80,normal_speed)
    gyro_straight_forward_print(-1,9,normal_speed)
mm_motor = MotorPair("A","B")
#gyro_straight_forward(0,80,normal_speed)
gyro_straight_forward_print(2,7,normal_speed)
"""mm_motor = MotorPair("A","B")
